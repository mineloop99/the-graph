...
export function updateTokenDayData(token: Token, event: ethereum.Event): TokenDayData {
  ...
  tokenDayData.liquidityETH = token.liquidity.times(token.derivedAVAX as BigDecimal)
  tokenDayData.liquidityUSD = tokenDayData.liquidityETH.times(bundle.avaxPrice)
